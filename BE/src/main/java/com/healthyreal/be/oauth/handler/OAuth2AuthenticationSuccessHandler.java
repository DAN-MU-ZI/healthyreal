package com.healthyreal.be.oauth.handler;

import static com.healthyreal.be.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.healthyreal.be.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
	...
	protected String determineTargetUrl(final HttpServletRequest request, final HttpServletResponse response,
		...
		if (redirectUri.isPresent() && !isAuthorizedRedirectUri(redirectUri.get())) {
			...
			log.info("{}", isAuthorizedRedirectUri(redirectUri.get()));
